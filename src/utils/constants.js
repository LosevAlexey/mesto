...
export const popupEditProfileAvatar = document.querySelector(".popup_type_avatar");
...
export const buttonOpenEditProfileAvatar = document.querySelector(".profile__avatar-button");
